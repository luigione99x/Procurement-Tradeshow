  ...
  return (
    <div className="grid gap-8 lg:grid-cols-3">
      ...
      <aside className="card h-fit">
        ...
        <JsonForm action="/api/fairs" submitLabel="Crea fiera">
          {actor.role === "admin" && (
            <div>
          ...
          <div><label className="label">Budget stand (€)</label><input name="budgetCents" data-type="cents" type="number" min="0" step="100" className="input" /></div>
